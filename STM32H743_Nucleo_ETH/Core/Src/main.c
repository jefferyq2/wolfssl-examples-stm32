...
/* USER CODE BEGIN PFP */
extern void wolf_shell(void *argument);
/* USER CODE END PFP */
...
int main(void)
{
  ...
  MX_RTC_Init();
  /* USER CODE BEGIN 2 */
  printf("Starting HTTPS w/TPM Demo\n");
  /* USER CODE END 2 */
...
void StartDefaultTask(void *argument)
{
  ...
  int rc = wolfTPM2_Init(&dev, TPM2_IoCb, TPM2_IOCB_CTX);
  if (rc != 0) {
  ...
  /* Start HTTPS server */
  https_server_wolf_init();

  /* run wolfCrypt demo shell */
  wolf_shell(NULL);
